...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function active_delayScroll() {
            setTimeout(function(){ 
                DoubleScroll(document.getElementById('div_gridViajes'));
            }, 1000);
        }
        ...
        <div class="box-header with-border" style="padding-bottom: 0;">
            ...
            <div id="tabsViajes">
                <ul>
                    ...
                    <li><a href="#tabsViajes_2" id="aTabsViajes_2" class="tabViajes" onclick="javascript:active_delayScroll();">Histórico de Viajes</a></li>
                </ul>
                                ...
                                <div id="div_gridViajesEnCurso" style="overflow: auto;">
                                    <asp:GridView ID="gridViajesEnCurso" runat="server" ClientIDMode="Static" HorizontalAlign="Center"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Costo fl.">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblCostoFletero" runat="server" CommandName="View" Text='<%# Eval("Costo_fletero") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td>
                                                    <div style="color: #ea4040">Fecha de partida: </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div id="tabsNotificaciones" style="padding-bottom: 20px;">
                                        <ul>
                                            ...
                                            <li><a href="#tabsNotificaciones_4" id="aTabsNotificaciones_4" class="tabViajes">Datos Fletero</a></li>
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <asp:UpdatePanel ID="upGridViajes" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <div id="div_gridViajes" style="overflow: auto;">
                                                    <asp:GridView ID="gridViajes" runat="server" ClientIDMode="Static" HorizontalAlign="Center" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Numero_factura" HeaderText="N. factura" ReadOnly="true" HtmlEncode="False" />
