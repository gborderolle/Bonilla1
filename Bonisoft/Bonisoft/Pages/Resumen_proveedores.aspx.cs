...
namespace Bonisoft.Pages
{
    public partial class Resumen_proveedores : System.Web.UI.Page
    {
        ...
        public static List<proveedor_pagos> GetPagosByMonth(bonisoftEntities context, int cliente_ID, int month_int, int year_int, bool include_ficticio = false)
        {
        ...
        public static List<proveedor_pagos> GetPagosToMonth(bonisoftEntities context, int cliente_ID, int month_int, int year_int, bool include_ficticio = false)
        {
            // Desde hace 5 años
