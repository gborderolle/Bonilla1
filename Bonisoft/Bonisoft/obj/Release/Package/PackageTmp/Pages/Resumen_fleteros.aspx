                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gridClientes" runat="server" ClientIDMode="Static" HorizontalAlign="Left"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Depto_empresa" HeaderText="Depto" HtmlEncode="false" />
                                        <asp:BoundField DataField="Telefono" HeaderText="Tel" HtmlEncode="false" />
                                    </Columns>
                                </asp:GridView>
                            ...
                            <div style="overflow: auto;">
                                <asp:UpdatePanel ID="upViajesImprimir" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 pull-left" style="margin-right: 10px; margin-bottom: 10px;">
                                                <div class="input-group">
