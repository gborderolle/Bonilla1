    ...
    public partial class Clientes : System.Web.UI.UserControl
    {
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                //To Export all pages
                gridClientes.AllowPaging = false;
                this.BindGrid();

                gridClientes.HeaderRow.BackColor = Color.White;
                foreach (TableCell cell in gridClientes.HeaderRow.Cells)
                {
                    cell.BackColor = gridClientes.HeaderStyle.BackColor;
                }
                foreach (GridViewRow row in gridClientes.Rows)
                {
                    ...
                    foreach (TableCell cell in row.Cells)
                    {
                        if (row.RowIndex % 2 == 0)
                        {
                            cell.BackColor = gridClientes.AlternatingRowStyle.BackColor;
                        }
                        else
                        {
                            cell.BackColor = gridClientes.RowStyle.BackColor;
                        }
                        cell.CssClass = "textmode";
                    }
                }

                gridClientes.RenderControl(hw);
